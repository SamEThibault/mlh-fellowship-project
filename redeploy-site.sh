...
# Do this if you want to run on port 80 to hide port in URL: (also add export FLASK_RUN_PORT=80 to tmux commands)
...
cd /home/GitHub/mlh-fellowship-project/app
tmux new-session -d -s flask_portfolio 'source /home/GitHub/mlh-fellowship-project/python3-virtualenv/bin/activate && export FLASK_APP=__init__.py && flask run --host=0.0.0.0; $SHELL'
